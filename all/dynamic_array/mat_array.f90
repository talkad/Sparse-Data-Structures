module mat_array_module
    ...
    type, extends(data_abstract_t) :: mat_array_t 
        ...
        integer, dimension(:,:,:), allocatable, public :: idx_map
    ...
    function mat_array_constructor(matrix)
        ...
        allocate(mat_array_constructor%idx_map(0:materials,0:nx,0:ny))
        ...
        do j = 0, ny
            do i = 0, nx
                ...
                do m=0, materials
                    mat_array_constructor%idx_map(m,i,j) = -1
        ...
        ! do j = 0, ny
        !     do i = 0, nx
        !         print*, 'size', j, i, size(mat_array_constructor%mat(i,j)%values)
        !         ! print*, mat_array_constructor%mat(i,j)%values

        !     end do
        ! end do
        ! print*, '-------------'

        ! print*, mat_array_constructor%idx_map
    end function
